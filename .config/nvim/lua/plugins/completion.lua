...
function M.config()
  ...
  vim.api.nvim_set_keymap('i', '<C-f>', [[compe#complete('<C-f>')]], { expr = true, noremap = true, silent = true })
  vim.api.nvim_set_keymap('i', '<CR>', [[compe#confirm(luaeval("require('nvim-autopairs').autopairs_cr()"))]], { expr = true, noremap = true, silent = true })
end
