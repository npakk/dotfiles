...
new TextLintEngine({
 rulesBaseDirectory: directory
    ...
    executeOnFiles(files) {
        ...
        const patterns = find_util_1.pathsToGlobPatterns(files, {
            extensions: this.textlintrcDescriptor.availableExtensions
        });
        const targetFiles = find_util_1.findFiles(patterns, { ignoreFilePath: this.config.ignoreFile });
        ...
        const { availableFiles, unAvailableFiles } = find_util_1.separateByAvailability(targetFiles, {
            extensions: this.textlintrcDescriptor.availableExtensions
        });
