...
class Config {
    ...
    constructor(options = {}) {
        ...
        const presetRulesConfig = preset_loader_1.loadRulesConfigFromPresets(this.presets, moduleResolver);
    ...
    static initWithAutoLoading(options = {}) {
        ...
        const configRuleNamesObject = separate_by_config_option_1.separateEnabledOrDisabled(configFileRaw.rules);
        const configFilterRuleNamesObject = separate_by_config_option_1.separateEnabledOrDisabled(configFileRaw.filters);
        const configPresetNames = configRuleNamesObject.presetNames;
        const configFilePlugins = plugin_loader_1.getPluginNames(configFileRaw);
        const configFilePluginConfig = plugin_loader_1.getPluginConfig(configFileRaw);
        ...
        const configFileRulesConfig = preset_loader_1.createFlatRulesConfigFromRawRulesConfig(configFileRaw.rules);
        const configFileFilterRulesConfig = preset_loader_1.createFlatRulesConfigFromRawRulesConfig(configFileRaw.filters);
