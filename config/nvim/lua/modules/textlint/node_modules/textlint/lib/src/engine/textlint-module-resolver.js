...
class TextLintModuleResolver {
    ...
    resolveRulePackageName(packageName) {
        ...
        const fullPackageName = textlint_package_name_util_1.createFullPackageName(package_prefix_1.PackageNamePrefix.rule, packageName);
...
`);
    ...
    resolveFilterRulePackageName(packageName) {
        const baseDir = this.baseDirectory;
        const fullPackageName = textlint_package_name_util_1.createFullPackageName(package_prefix_1.PackageNamePrefix.filterRule, packageName);
...
`);
    ...
    resolvePluginPackageName(packageName) {
        const baseDir = this.baseDirectory;
        const fullPackageName = textlint_package_name_util_1.createFullPackageName(package_prefix_1.PackageNamePrefix.plugin, packageName);
...
`);
    ...
    resolvePresetPackageName(packageName) {
        ...
        const packageNameWithoutPreset = packageName
            .replace(/^preset-/, "")
            .replace(/^@([^/]+)\/preset-(.*)$/, `@$1/$2`);
        const fullPackageName = textlint_package_name_util_1.createFullPackageName(PREFIX, packageNameWithoutPreset);
...
`);
    ...
    resolveConfigPackageName(packageName) {
        const baseDir = this.baseDirectory;
        const fullPackageName = textlint_package_name_util_1.createFullPackageName(package_prefix_1.PackageNamePrefix.config, packageName);
